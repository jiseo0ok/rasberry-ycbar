...
public class Updateml extends AsyncTask<String, Void, String> {

    private static final String TAG = Updateml.class.getSimpleName();

    @Override
    protected String doInBackground(String... params) {
        String updateUrl = "http://bighero.iptime.org/updateml.php"; // 여기에 PHP 스크립트의 URL을 입력하세요.
